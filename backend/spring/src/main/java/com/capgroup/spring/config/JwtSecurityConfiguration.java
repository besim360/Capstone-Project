...
import com.capgroup.spring.keycloak.KeycloakGrantedAuthoritiesConverter;
...
/**
 * Configures JWT handling (decoder and validator) NOTE: taken from https://github.com/thomasdarimont/keycloak-project-example
 */
@Configuration
class JwtSecurityConfiguration {
    ...
    @Bean
    Converter<Jwt, Collection<GrantedAuthority>> keycloakGrantedAuthoritiesConverter(GrantedAuthoritiesMapper authoritiesMapper, JavaServiceProperties javaServiceProperties) {
        String clientId = javaServiceProperties.getJwt().getClientId();
